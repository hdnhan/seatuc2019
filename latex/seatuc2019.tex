...
\twocolumn[
	...
	\begin{@twocolumnfalse}
		\rule{\textwidth}{.1pt}
		\begin{abstract}
			Heat transfer via conduction in solid objects is an important part in thermal engineering and solid mechanics. Its mathematical expression, the parabolic equation, also received large amount of attention by mathematician whose numerous researches have been studied to solve the equation numerically. For physicist interest, software like Ansys, Solidwork provide sufficient simulation features, but also lack of mathematical clarity for mathematicians. For such purpose, we use Freefem++ software in study of heat transfer which produces both mathematic structures and powerful simulation qualification.
		\end{abstract}
		\vspace{1ex}
